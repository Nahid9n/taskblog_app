...
<!-- FAVICON -->
<link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}website/assets/img/bitm-logo.png" />
...
<link id="style" href="{{asset('/')}}admin/assets/css/bootstrap.min.css" rel="stylesheet" />
<link id="style" href="{{asset('/')}}admin/assets/css/all.css" rel="stylesheet" />

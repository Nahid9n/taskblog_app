...
@section('title','Manage Sponsored Blog')
@section('body')
    <!-- PAGE-HEADER -->
    <div class="page-header">
        <div>
            <h1 class="page-title">Sponsored Blog Module</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Manage Sponsored Blog</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="border-bottom py-5">
                    <div class="row">
                        <div class="col-6">
                            <h3 class="fw-bold text-end">Sponsored Blog Table</h3>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table id="example3" class="table table-bordered text-nowrap border-bottom">
                            ...
                            <tr class="text-center">
                                ...
                                <th class="border-bottom-0">sponsoredBlog Images</th>
                            ...
                            @foreach($sponsoredBlogs as $sponsoredBlog)
                                <tr class="text-center">
                                    ...
                                    <td>{{$sponsoredBlog->author}}</td>
                                    <td>{{$sponsoredBlog->category->name}}</td>
                                    <td><img width="150" src="{{asset($sponsoredBlog->image)}}" alt=""></td>
                                    <td>{{$sponsoredBlog->status == 1 ? 'published':'unpublished'}}</td>
                                    <td class="text-center">
                                        <a href="{{route('sponsoredBlog.show',$sponsoredBlog->id)}}" class="btn btn-primary mb-1 mx-1"><i class="fa-regular fa-eye"></i></a>

                ...
                <div class="border-bottom py-5">
                    <div class="row">
                        ...
                        <div class="col-5 text-end me-1">
                            <a href="{{route('userBlog.create')}}" class="btn text-dark px-5 btn-success">Add Blog</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            @foreach($blogs as $blog)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('userBlog.show',$blog->id)}}" class="btn btn-primary mb-1 mx-1"><i class="fa-regular fa-eye"></i></a>
                                        <a href="{{route('userBlog.edit',$blog->id)}}" class="btn btn-primary mb-1 mx-1"><i class="fa-regular fa-edit"></i></a>

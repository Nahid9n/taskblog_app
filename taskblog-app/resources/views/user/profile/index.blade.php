        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="p-5">
                                ...
                                <p class="text-dark-light">{!! $profile->biographicalInfo !!}</p>
                            </div>
                            ...
                            <div class="table-responsive p-5">
                                ...
                                <table class="table row table-borderless">
                                    ...
                                    <tr>
                                        <td><strong>Full Name :</strong> {{$profile->firstname}} {{$profile->lastname}} {{$profile->nickname}}</td>
                                    </tr>
                                    </tbody>
                                    <tbody class="col-lg-12 col-xl-6 p-0 border-top-0">
                                    <tr>
                                        <td><strong>Website :</strong> {{$profile->website}}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Email :</strong> {{$profile->email}}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Phone :</strong> {{$profile->phoneNumber}} </td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <div class="profile-cover__info ms-4 ms-auto p-0">
                                    <ul class="nav p-0 border-bottom-0 mb-0">
                                        <li class="border p-2 br-5 bg-light-lightest wpx-100 hpx-70 text-center my-1">
                                            <span class="border-0 mb-0 pb-0 fs-21">(04)</span>
                                            blogs
                                        </li>
                                        ...
                                        <div class="main-profile-contact-list">
                                            <div class="media mx-2">
                                                ...
                                                <div class="media-body ms-1">
                                                    ...
                                                    <p class="mb-0"> <a href="javascript:void(0)" class="text-default">{{$profile->github}}</a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="main-profile-contact-list">
                                            <div class="media mx-2">
                                                ...
                                                <div class="media-body ms-2">
                                                    ...
                                                    <p class="mb-0"> <a href="javascript:void(0)" class="text-default">{{$profile->twitter}}</a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="main-profile-contact-list">
                                            <div class="media mx-2">
                                                ...
                                                <div class="media-body ms-2">
                                                    ...
                                                    <p class="mb-0"> <a href="javascript:void(0)" class="text-default">{{$profile->linkedin}}</a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="tab-pane" id="editProfile">
                    @foreach($profiles as $profile)
                    <div class="card">
                        <a class="btn btn-outline-success" href="{{route('userProfile.edit',$profile->id)}}">Edit</a>
                        <div class="card-body border-0">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="firstname" id="firstname" placeholder="First Name" value="{{$profile->firstname}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            <label for="lastname" class="form-label">last Name</label>
                                            <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Last Name" value="{{$profile->lastname}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            <label for="nickname" class="form-label">Nick Name</label>
                                            <input type="text" name="nickname" class="form-control" id="nickname" placeholder="Nick Name" value="{{$profile->nickname}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            <label for="designation" class="form-label">Designation</label>
                                            <input type="text" class="form-control" name="designation" id="designation" placeholder="Designation" value="{{$profile->designation}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="{{$profile->email}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="website" name="website" placeholder="Website" value="{{$profile->website}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="phone number" value="{{$profile->phoneNumber}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="address" name="address" rows="2" placeholder="Address" readonly>{{$profile->address}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="twitter" id="twitter" placeholder="twitter" value="{{$profile->twitter}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="facebook" id="facebook" placeholder="facebook" value="{{$profile->facebook}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="googlePlus" id="googlePlus" placeholder="google" value="{{$profile->googlePlus}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="linkedin" id="linkedin" placeholder="linkedin" value="{{$profile->linkedin}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="github" id="github" placeholder="github" value="{{$profile->github}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="biographicalInfo" id="biographicalInfo" rows="4" placeholder="" readonly>{!! $profile->biographicalInfo !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                        </div>
                ...
                <div class="tab-pane" id="gallery">
                    <div class="row  mb-5 img-gallery" id="lightgallery">
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/8.jpg" data-src="{{asset('')}}assets/images/media/8.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/8.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/10.jpg" data-src="{{asset('')}}assets/images/media/10.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/10.jpg" alt="banner image "></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/11.jpg" data-src="{{asset('')}}assets/images/media/11.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/11.jpg" alt="banner image "></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/12.jpg" data-src="{{asset('')}}assets/images/media/12.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/12.jpg" alt="banner image "></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/13.jpg" data-src="{{asset('')}}assets/images/media/13.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/13.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/14.jpg" data-src="{{asset('')}}assets/images/media/14.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/14.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/15.jpg" data-src="{{asset('')}}assets/images/media/15.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/15.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/16.jpg" data-src="{{asset('')}}assets/images/media/16.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/16.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/17.jpg" data-src="{{asset('')}}assets/images/media/17.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/17.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/18.jpg" data-src="{{asset('')}}assets/images/media/18.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/18.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/19.jpg" data-src="{{asset('')}}assets/images/media/19.jpg">
                            <a href="#"><img class="img-fluid wp-100 mb-2 br-5" src="{{asset('')}}assets/images/media/19.jpg" alt="banner image"></a>
                        </div>
                        <div class="col-lg-3 col-md-6" data-responsive="https://laravel8.spruko.com/noa/{{asset('')}}assets/images/media/20.jpg" data-src="{{asset('')}}assets/images/media/20.jpg">

                ...
                <div class="tab-pane active show" id="editProfile">
                    <div class="card">
                        <div class="card-body border-0">
                            <form class="form-horizontal" method="post" action="{{route('userProfile.update',$userProfile->id)}}">
                                @csrf
                                @method('PUT')
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="firstname" id="firstname" placeholder="First Name" value="{{ $userProfile->firstname }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12 col-xl-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="{{ $userProfile->email }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control summernote" name="biographicalInfo" id="biographicalInfo" rows="4" placeholder="">{{ $userProfile->biographicalInfo }}</textarea>
                                        </div>
                                    </div>
                                </div>
